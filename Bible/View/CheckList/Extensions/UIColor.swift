...
//  BibleCheckList
//
//  Created by eunjin Jo on 06/11/2018.
...
extension UIColor {
    ...
    class var lightMint: UIColor {
        return UIColor(red: 105.0 / 255.0, green: 200.0 / 255.0, blue: 161.0 / 255.0, alpha: 1.0)
    }
    
    class var darkMint: UIColor {
        return UIColor(red: 63.0 / 255.0, green: 180.0 / 255.0, blue: 136.0 / 255.0, alpha: 1.0)
    }
}
